...
let data_1 = ''
let data_2 = ''
const search = function(data_1, data_2){
    console.log(users.filter(el => el.registrationDate === data_1));
    console.log(users.filter(el => el.registrationDate === data_2));
}
search('09.10.2021', '10.10.2021')